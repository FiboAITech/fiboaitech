...
def main():
    ...
    mistral_text_embedder_node = MistralTextEmbedder(
        name="MistralTextEmbedder", connection=mistral_connection
    )
    cohere_text_embedder_node = CohereTextEmbedder(
        name="CohereTextEmbedder", connection=cohere_connection
    )
    huggingface_text_embedder_node = HuggingFaceTextEmbedder(
        name="HuggingFaceTextEmbedder", connection=huggingface_connection
    )
    bedrock_text_embedder_node = BedrockTextEmbedder(
        name="BedrockTextEmbedder", connection=bedrock_connection
    )

    mistral_document_embedder_node = MistralDocumentEmbedder(
        name="MistralDocumentEmbedder", connection=mistral_connection
    )
    cohere_document_embedder_node = CohereDocumentEmbedder(
        name="CohereDocumentEmbedder", connection=cohere_connection
    )
