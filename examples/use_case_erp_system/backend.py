...
from fiboaitech.connections import HttpApiKey
...
from examples.use_case_smm_manager.mailgun_tool import MailGunTool

PERSONALITY = """
I am FiboAITech Assistant, your smart and friendly ERP System Assistant.
...
ROLE = """
Some of the key responsibilities of the FiboAITech Assistant include:
