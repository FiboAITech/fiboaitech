...
AGENT_PERSONALITY = """
I am FiboAITech Name Assistant, your smart and friendly ERP System Assistant.
...
# Create the agent
fiboaitech_name_assistant = ReActAgent(
    name="FiboAITech Name Assistant",
    llm=llm,
    tools=[db_tool],
    memory=memory,
    role=AGENT_ROLE,
...
# Example user query
result = fiboaitech_name_assistant.run(
    input_data={
