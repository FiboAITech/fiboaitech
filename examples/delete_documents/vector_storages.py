from fiboaitech.connections import Chroma as ChromaConnection
from fiboaitech.connections import Pinecone as PineconeConnection
from fiboaitech.connections import Weaviate as WeaviateConnection
from fiboaitech.storages.vector import (
    ChromaVectorStore,
    PineconeVectorStore,
    WeaviateVectorStore,
)
...
def delete_weaviate_documents_by_file_id(
    api_key: str, url: str, index_name: str, file_id: str
):
    """
...
def delete_chroma_documents_by_file_id(
    host: str, port: str, index_name: str, file_id: str
):
    """
