...
def run_python_node_with_fiboaitech_import():
    """Basic example of running Python node with fiboaitech relative import."""
    python_code_with_math = """
...
"""
    ...
    config = None
    result = python_node.run(input_data, config)
    print("\nResult with fiboaitech relative import:")
    print(result)
...
if __name__ == "__main__":
    ...
    run_python_node_with_fiboaitech_import()
