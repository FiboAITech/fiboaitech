"""
This script sets up and runs a question-answering system using the FiboAITech framework.
...
# Constants
AGENT_ROLE = """FiboAITech AI, an AI model who is expert at searching the web and answering user's queries.Goal is
