...
# Import FiboAITech evaluators
from fiboaitech.evaluations.metrics import ContextRecallEvaluator, FaithfulnessEvaluator
...
def main(
    ...
    with get_connection_manager() as cm:
        ...
        # Initialize FiboAITech Evaluators
        ...
        logger.info(f"FiboAITech Evaluation Result:\n {eval_metrics}")
