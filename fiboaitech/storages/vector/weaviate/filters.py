...
from fiboaitech.storages.vector.exceptions import VectorStoreFilterException


def convert_filters(filters: dict[str, Any]) -> FilterReturn:
    """
    Convert filters from fiboaitech format to Weaviate format.

    Args:
        filters (dict[str, Any]): Filters in fiboaitech format.
