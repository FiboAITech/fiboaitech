...
def convert_fiboaitech_documents_to_qdrant_points(
...
def convert_qdrant_point_to_fiboaitech_document(point: QdrantPoint, use_sparse_embeddings: bool = False) -> Document:
