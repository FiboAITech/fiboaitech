...
from fiboaitech.components.converters.base import BaseConverter
from fiboaitech.components.converters.utils import get_filename_for_bytesio
from fiboaitech.connections import Unstructured as UnstructuredConnection
from fiboaitech.types import Document, DocumentCreationMode
...
class UnstructuredFileConverter(BaseConverter):
    ...
    Usage example:
    ```python
    from fiboaitech.components.converters.unstructured.file_converter import UnstructuredFileConverter
