...
from fiboaitech.components.splitters.document import DocumentSplitBy
from fiboaitech.components.splitters.document import DocumentSplitter as DocumentSplitterComponent
