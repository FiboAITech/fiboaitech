...
from fiboaitech.nodes.node import Node, NodeDependency, NodeGroup, ensure_config
from fiboaitech.prompts import (
    Prompt,
    VisionMessage,
...
class LLMImageConverter(Node):
    ...
    Example:
        ...
        from fiboaitech.nodes.extractors import ImageLLMExtractor
        from io import BytesIO
...
class LLMPDFConverter(LLMImageConverter):
    ...
    Example:
        ...
        from fiboaitech.nodes.converters import LLMPDFConverter
        from io import BytesIO
