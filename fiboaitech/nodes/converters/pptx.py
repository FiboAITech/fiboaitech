...
from fiboaitech.components.converters.pptx import PPTXConverter as PPTXConverterComponent
...
from fiboaitech.types import DocumentCreationMode
from fiboaitech.utils.logger import logger


class PPTXFileConverterInputSchema(BaseModel):
