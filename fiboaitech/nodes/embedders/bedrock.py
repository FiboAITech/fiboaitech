from fiboaitech.components.embedders.bedrock import BedrockEmbedder as BedrockEmbedderComponent
from fiboaitech.connections import AWS as BedrockConnection
