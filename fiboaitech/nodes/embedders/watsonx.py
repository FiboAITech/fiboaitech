from fiboaitech.components.embedders.watsonx import WatsonXEmbedder as WatsonXEmbedderComponent
from fiboaitech.connections import WatsonX as WatsonXConnection
