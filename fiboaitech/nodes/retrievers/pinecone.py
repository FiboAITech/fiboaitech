...
from fiboaitech.components.retrievers.pinecone import (
    PineconeDocumentRetriever as PineconeDocumentRetrieverComponent,
)
...
class PineconeDocumentRetriever(VectorStoreNode, PineconeVectorStoreParams):
