...
from fiboaitech.storages.vector.milvus.filter import Filter
...
def test_delete_documents_by_file_id(milvus_vector_store, mock_milvus_client):
    file_id = "file_id"
    with patch("fiboaitech.storages.vector.utils.create_file_id_filter", return_value={"file_id": file_id}):
