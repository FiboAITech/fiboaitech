...
from fiboaitech.storages.vector.qdrant.converters import convert_id, convert_qdrant_point_to_fiboaitech_document
...
def test_point_to_document_reverts_proper_structure_from_record_without_sparse():
    ...
    document = convert_qdrant_point_to_fiboaitech_document(point, content_key="content")
