...
from fiboaitech.components.retrievers.pgvector import PGVectorDocumentRetriever as PGVectorDocumentRetrieverComponent
...
from fiboaitech.nodes.retrievers.pgvector import PGVectorDocumentRetriever
from fiboaitech.runnables import RunnableConfig
from fiboaitech.storages.vector import PGVectorStore
...
def mock_pgvector_connect():
    with patch("fiboaitech.connections.connections.PostgreSQL.connect", return_value=MagicMock()) as mock_connect:
        yield mock_connect
