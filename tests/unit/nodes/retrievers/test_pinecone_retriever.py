...
from fiboaitech.components.retrievers.pinecone import PineconeDocumentRetriever as PineconeDocumentRetrieverComponent
...
from fiboaitech.nodes.retrievers.pinecone import (
...
@patch("fiboaitech.storages.vector.pinecone.pinecone.PineconeVectorStore.connect_to_index", return_value=MagicMock())
@patch("fiboaitech.connections.Pinecone.connect", return_value=MagicMock())
