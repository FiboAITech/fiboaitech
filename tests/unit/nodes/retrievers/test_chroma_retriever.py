...
from fiboaitech.components.retrievers.chroma import ChromaDocumentRetriever as ChromaDocumentRetrieverComponent
from fiboaitech.connections import Chroma
...
from fiboaitech.nodes.retrievers.chroma import ChromaDocumentRetriever
...
@patch("fiboaitech.connections.Chroma.connect", return_value=MagicMock())
