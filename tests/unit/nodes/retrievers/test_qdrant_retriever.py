...
from fiboaitech.components.retrievers.qdrant import QdrantDocumentRetriever as QdrantDocumentRetrieverComponent
from fiboaitech.connections import Qdrant
...
from fiboaitech.nodes.retrievers.qdrant import QdrantDocumentRetriever
from fiboaitech.runnables import RunnableConfig
from fiboaitech.storages.vector import QdrantVectorStore
...
def test_execute_with_missing_embedding_key(qdrant_document_retriever):
    ...
    with pytest.raises(ValidationError):
        qdrant_document_retriever.execute(RetrieverInputSchema(), config)
