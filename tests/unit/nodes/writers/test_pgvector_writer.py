...
from fiboaitech.nodes.writers.base import WriterInputSchema
from fiboaitech.nodes.writers.pgvector import PGVectorDocumentWriter
from fiboaitech.runnables import RunnableConfig
from fiboaitech.storages.vector.base import BaseWriterVectorStoreParams
from fiboaitech.storages.vector.pgvector.pgvector import PGVectorStore
...
def test_execute_with_missing_documents_key(pgvector_document_writer):
    ...
    with pytest.raises(ValidationError):
        pgvector_document_writer.execute(WriterInputSchema(), config)
