...
from fiboaitech.nodes.retrievers import QdrantDocumentRetriever
from fiboaitech.runnables import RunnableConfig, RunnableResult, RunnableStatus
from fiboaitech.storages.vector.qdrant.qdrant import QdrantVectorStore
...
def mock_query_by_embedding(mock_documents):
    with patch(
        "fiboaitech.storages.vector.qdrant.qdrant.QdrantVectorStore._query_by_embedding",
...
@patch("fiboaitech.storages.vector.qdrant.qdrant.QdrantVectorStore._set_up_collection")
