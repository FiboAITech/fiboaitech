...
from fiboaitech.connections import Milvus as MilvusConnection
from fiboaitech.connections import MilvusDeploymentType
from fiboaitech.flows import Flow
from fiboaitech.nodes.retrievers.milvus import MilvusDocumentRetriever
from fiboaitech.runnables import RunnableConfig, RunnableResult, RunnableStatus
from fiboaitech.storages.vector.milvus.milvus import MilvusVectorStore
...
def mock_search_embeddings(mock_documents):
    with patch(
        "fiboaitech.storages.vector.milvus.milvus.MilvusVectorStore.search_embeddings",
...
@patch("fiboaitech.callbacks.TracingCallbackHandler.on_flow_start")
@patch("fiboaitech.callbacks.TracingCallbackHandler.on_flow_end")
