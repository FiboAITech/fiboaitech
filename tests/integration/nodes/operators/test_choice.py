...
from fiboaitech.callbacks.tracing import RunStatus, RunType
from fiboaitech.flows import Flow
from fiboaitech.nodes import ErrorHandling
from fiboaitech.nodes.operators import operators
...
def test_workflow_with_choice_operator_with_errors_and_retries(
    ...
    mocker.patch(
        "fiboaitech.nodes.operators.operators.Choice.execute",
