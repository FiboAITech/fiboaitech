...
from fiboaitech.nodes.writers import QdrantDocumentWriter
...
def mock_set_up_collection():
    with patch(
        "fiboaitech.storages.vector.qdrant.qdrant.QdrantVectorStore._set_up_collection", return_value=None
    ) as mock_set_up:
        yield mock_set_up
